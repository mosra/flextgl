...
void(*flextglDeleteVertexArraysOES)(GLsizei, const GLuint *) = nullptr;
#define glDeleteVertexArraysOES flextglDeleteVertexArraysOES
void(*flextglGenVertexArraysOES)(GLsizei, GLuint *) = nullptr;
#define glGenVertexArraysOES flextglGenVertexArraysOES
GLboolean(*flextglIsVertexArrayOES)(GLuint) = nullptr;
...
void flextGLInit() {
    ...
    flextglDeleteVertexArraysOES = reinterpret_cast<void(*)(GLsizei, const GLuint *)>(load("glDeleteVertexArraysOES"));
    flextglGenVertexArraysOES = reinterpret_cast<void(*)(GLsizei, GLuint *)>(load("glGenVertexArraysOES"));
    flextglIsVertexArrayOES = reinterpret_cast<GLboolean(*)(GLuint)>(load("glIsVertexArrayOES"));
}
